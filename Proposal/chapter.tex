...
\caption{\label{fig:org4d800f5}Construction project-driven production system}
\end{figure}
...
\caption{\label{fig:org6e5ee06}Transient analysis for unit step input \label{fig:Transient}}
\end{figure}
...
\label{sec:org2588624}
\subsubsection{Production forecast}
\label{sec:org86a1a6f}
...
\label{sec:orge5f6389}
\subsubsection{Production plan, monitoring, and control}
\label{sec:org71179a2}
\begin{enumerate}
\item Throughput
\label{sec:org0f59c3c}
...
\label{sec:org6cd7f74}
\item Worst cycle-time
\label{sec:org4af1498}
\item Best cycle-time
\label{sec:org3769b0b}
\end{enumerate}
\item Capacity
\label{sec:org1855d71}
...
\label{sec:org2efdf5a}
\subsection{Automation and technology}
\label{sec:org4c27ca6}
\subsubsection{Supervisory control and data acquisition (SCADA)}
\label{sec:orgf23b763}
\subsubsection{Challenges}
\label{sec:orgeb959d7}
\subsection{Decision-making support}
\label{sec:org97de6d3}
\subsection{Benefits and impacts}
\label{sec:org6fa07ef}
\section{Discussion}
\label{sec:orgd432dcd}
\section{Conclusion}
\label{sec:orgdcf5b56}

\section{Plan}
\label{sec:org4587b82}
\begin{center}
\begin{tabular}{lrlrr}
...
\label{sec:org38d68c4}

\section{References}
\label{sec:org1a8c578}
