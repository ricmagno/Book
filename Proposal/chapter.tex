...
\caption{\label{fig:org1c63e49}Simple system}
\end{figure}
...
\caption{\label{fig:org5b12bf7}Construction project-driven production system}
\end{figure}
...
\caption{\label{fig:orgd47b4b4}Transient analysis for unit step input \label{fig:Transient}}
\end{figure}
...
\label{sec:org05de7c7}
\subsubsection{Production forecast}
\label{sec:org71f2ef6}
...
\label{sec:org4092c38}
\subsubsection{Production plan, monitoring, and control}
\label{sec:org24d9c40}
\begin{enumerate}
\item Throughput
\label{sec:org5277e34}
...
\label{sec:org1263daa}
\item Worst cycle-time
\label{sec:org2aac38b}
\item Best cycle-time
\label{sec:org13dd2d2}
\end{enumerate}
\item Capacity
\label{sec:org9fc4530}
...
\label{sec:orgba557ee}
\subsection{Automation and technology}
\label{sec:org3a7685a}
\subsubsection{Supervisory control and data acquisition (SCADA)}
\label{sec:orgd0d7821}
\subsubsection{Challenges}
\label{sec:org4d87746}
\subsection{Decision-making support}
\label{sec:orgec5a1a9}
\subsection{Benefits and impacts}
\label{sec:orgcd72544}
\section{Discussion}
\label{sec:org48dca9b}
\section{Conclusion}
\label{sec:org80d7dac}

\section{Plan}
\label{sec:orgc6dc74e}
\begin{center}
\begin{tabular}{lrlrr}
...
\label{sec:orga1d67dc}

\section{References}
\label{sec:org2eab439}
