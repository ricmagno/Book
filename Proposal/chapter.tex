...
\caption{\label{fig:org54dbf0a}Simple system}
\end{figure}
...
\caption{\label{fig:orgb9c107f}A typical feedback loop control}
\end{figure}
...
\caption{\label{fig:orgd6c07c3}Construction project-driven production system}
\end{figure}
...
\caption{\label{fig:org6e3c837}Transient analysis for unit step input \label{fig:Transient}}
\end{figure}
...
\label{sec:org1932ea8}
\subsubsection{Production forecast}
\label{sec:orgcb99b0e}
...
\label{sec:org5a294e0}
\subsubsection{Production plan, monitoring, and control}
\label{sec:orgc7ae3d3}
\begin{enumerate}
\item Throughput
\label{sec:org0ca4641}
...
\label{sec:org848e7c4}
\item Worst cycle-time
\label{sec:orgde54c2d}
\item Best cycle-time
\label{sec:org72993cf}
\end{enumerate}
\item Capacity
\label{sec:org5eda0d0}
...
\label{sec:org0fad43c}
\subsection{Automation and technology}
\label{sec:orgaf1abbf}
\subsubsection{Supervisory control and data acquisition (SCADA)}
\label{sec:org6d752e7}
\subsubsection{Challenges}
\label{sec:org5187d66}
\subsection{Decision-making support}
\label{sec:org438f3c8}
\subsection{Benefits and impacts}
\label{sec:org72b2969}
\section{Discussion}
\label{sec:org63016a1}
\section{Conclusion}
\label{sec:org02253ac}

\section{Plan}
\label{sec:orgd245c13}
\begin{center}
\begin{tabular}{lrlrr}
...
\label{sec:orgd93b1ad}

\section{References}
\label{sec:org438e498}
