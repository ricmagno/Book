...
\caption{\label{fig:org27fa7d8}Simple system}
\end{figure}
...
\caption{\label{fig:orga50547b}Transient analysis for unit step input \label{fig:Transient}}
\end{figure}
...
\label{sec:org97d0f80}
\subsubsection{Production forecast}
\label{sec:org2f5f7e6}
...
\label{sec:org116567e}
\subsubsection{Production plan, monitoring, and control}
\label{sec:orgc5d13a1}
\begin{enumerate}
\item Throughput
\label{sec:orge91b2c4}
...
\label{sec:orge073cfb}
\item Worst cycle-time
\label{sec:org1b0db36}
\item Best cycle-time
\label{sec:orgc12cef6}
\end{enumerate}
\item Capacity
\label{sec:org2cfad5f}
