...
\caption{\label{fig:org4299d59}Simple system}
\end{figure}
...
\caption{\label{fig:orgfe8ff5e}Transient analysis for unit step input \label{fig:Transient}}
\end{figure}
...
\label{sec:org0a0f3f9}
\subsubsection{Production forecast}
\label{sec:orgb39e9d1}
...
\label{sec:org13e3493}
\subsubsection{Production plan, monitoring, and control}
\label{sec:org2f8ad47}
\begin{enumerate}
\item Throughput
\label{sec:org91b4eb5}
...
\label{sec:orge8e9523}
\item Worst cycle-time
\label{sec:org30033e4}
\item Best cycle-time
\label{sec:org21820d5}
\end{enumerate}
\item Capacity
\label{sec:orgae8bb70}
...
\label{sec:org3f82ecf}
\subsection{Automation and technology}
\label{sec:org5bb71bd}
\subsubsection{Supervisory control and data acquisition (SCADA)}
\label{sec:org33984cd}
\subsubsection{Challenges}
\label{sec:org70656f8}
\subsection{Decision-making support}
\label{sec:orgfa53465}
\subsection{Benefits and impacts}
\label{sec:org5b5bbbb}
\section{Discussion}
\label{sec:orgd1e7990}
\section{Conclusion}
\label{sec:org7e95889}

\section{Plan}
\label{sec:org8efc576}
\begin{center}
\begin{tabular}{lrlrr}
...
\label{sec:org86d2ec1}

\section{References}
\label{sec:orgdea13ec}
