...
\usepackage[backend=bibtex,style=apa]{biblatex}\addbibresource{/Users/ricmagno/Documents/References/library.bib}
...
\begin{figure}[htbp]
\centering
\includegraphics[height=150]{./Figures/Construction_project_driven_production_system.weps}
...
\caption{\label{fig:org8d5d5c0}Transient analysis for unit step input \label{fig:Transient}}
\end{figure}
...
\item Applicability
\label{sec:orgf1be175}
\begin{enumerate}
\item Automation and technology
\label{sec:org38833c6}
\begin{enumerate}
\item Supervisory control and data acquisition (SCADA)
\label{sec:org9348f82}
\item Challenges
\label{sec:org26b87a0}
\end{enumerate}
\item Decision-making support
\label{sec:orga7a025c}
\item Benefits and impacts
\label{sec:orga3e878a}
\end{enumerate}
\item Discussion
\label{sec:org7bede92}
\item Conclusion
\label{sec:org4e86cc2}
Papers:
