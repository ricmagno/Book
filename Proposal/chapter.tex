...
\caption{\label{fig:org1fd4689}Simple system}
\end{figure}
...
\caption{\label{fig:orgb8f76f7}A typical feedback loop control}
\end{figure}
...
\caption{\label{fig:org501c9e7}Construction project-driven production system}
\end{figure}
...
\caption{\label{fig:org3a92258}Transient analysis for unit step input \label{fig:Transient}}
\end{figure}
...
\label{sec:org46dca6f}
\subsubsection{Production forecast}
\label{sec:org88e963f}
...
\label{sec:orgec1d9e8}
\subsubsection{Production plan, monitoring, and control}
\label{sec:org074282a}
\begin{enumerate}
\item Throughput
\label{sec:org32da8fd}
...
\label{sec:orgf944b6c}
\item Worst cycle-time
\label{sec:orgea62e65}
\item Best cycle-time
\label{sec:org7592f5a}
\end{enumerate}
\item Capacity
\label{sec:org1bddd48}
...
\label{sec:org152a41c}
\subsection{Automation and technology}
\label{sec:orgac825d1}
\subsubsection{Supervisory control and data acquisition (SCADA)}
\label{sec:org6f41201}
\subsubsection{Challenges}
\label{sec:orgb90109d}
\subsection{Decision-making support}
\label{sec:org1a299ce}
\subsection{Benefits and impacts}
\label{sec:org8983e55}
\section{Discussion}
\label{sec:org1683826}
\section{Conclusion}
\label{sec:orgad65bfb}

\section{Plan}
\label{sec:org02bc1a5}
\begin{center}
\begin{tabular}{lrlrr}
...
\label{sec:org7aca6d9}

\section{References}
\label{sec:org28e2ed7}
