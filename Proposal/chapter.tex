...
\caption{\label{fig:org8c5fe5a}Simple system}
\end{figure}
...
\caption{\label{fig:org0ae00ad}Construction project-driven production system}
\end{figure}
...
\caption{\label{fig:orgd59127f}Transient analysis for unit step input \label{fig:Transient}}
\end{figure}
...
\label{sec:orgb1e5984}
\subsubsection{Production forecast}
\label{sec:org21dbdb0}
...
\label{sec:orgd9be29b}
\subsubsection{Production plan, monitoring, and control}
\label{sec:org53eccdf}
\begin{enumerate}
\item Throughput
\label{sec:org868a8d1}
...
\label{sec:org00e1e0d}
\item Worst cycle-time
\label{sec:org3eefdd1}
\item Best cycle-time
\label{sec:orga2acf92}
\end{enumerate}
\item Capacity
\label{sec:org9317026}
...
\label{sec:org87c1e79}

\section{References}
\label{sec:org48bcbeb}
