...
\caption{\label{fig:org9dc38a9}A typical feedback loop control}
\end{figure}
...
\caption{\label{fig:org88553d2}Construction project-driven production system}
\end{figure}
...
\caption{\label{fig:orgf949aaa}Transient analysis for unit step input \label{fig:Transient}}
\end{figure}
...
\label{sec:org342462d}
\subsubsection{Production forecast}
\label{sec:orgab9796d}
...
\label{sec:org9e882c1}
\subsubsection{Production plan, monitoring, and control}
\label{sec:org0e47518}
\begin{enumerate}
\item Throughput
\label{sec:org7b8a554}
...
\label{sec:org55e51f9}
\item Worst cycle-time
\label{sec:org6639b59}
\item Best cycle-time
\label{sec:org4e7497a}
\end{enumerate}
\item Capacity
\label{sec:orgaafa1fa}
...
\label{sec:orge442789}
\subsection{Automation and technology}
\label{sec:org7599194}
\subsubsection{Supervisory control and data acquisition (SCADA)}
\label{sec:org218ecfc}
\subsubsection{Challenges}
\label{sec:orga1369a9}
\subsection{Decision-making support}
\label{sec:org5fd4f1c}
\subsection{Benefits and impacts}
\label{sec:org071c767}
\section{Discussion}
\label{sec:orga504037}
\section{Conclusion}
\label{sec:org9de5574}

\section{Plan}
\label{sec:orgcfbbb17}
\begin{center}
\begin{tabular}{lrlrr}
...
\label{sec:org657ac24}

\section{References}
\label{sec:org410f798}
