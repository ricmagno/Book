...
\caption{\label{fig:orgc6c5dd9}Construction project-driven production system}
\end{figure}
...
\caption{\label{fig:orgddb7e13}Transient analysis for unit step input \label{fig:Transient}}
\end{figure}
...
\label{sec:org1335c55}
\subsubsection{Production forecast}
\label{sec:org42d2dc4}
...
\label{sec:orgbd58711}
\subsubsection{Production plan, monitoring, and control}
\label{sec:org2d441d2}
\begin{enumerate}
\item Throughput
\label{sec:org6ae20c3}
...
\label{sec:org9d82ec6}
\item Worst cycle-time
\label{sec:orgb3fba70}
\item Best cycle-time
\label{sec:orgac6012d}
\end{enumerate}
\item Capacity
\label{sec:orgfd06288}
...
\label{sec:orgd938d2e}
\subsection{Automation and technology}
\label{sec:org344a268}
\subsubsection{Supervisory control and data acquisition (SCADA)}
\label{sec:orgfd57132}
\subsubsection{Challenges}
\label{sec:orgc2239ea}
\subsection{Decision-making support}
\label{sec:orge763302}
\subsection{Benefits and impacts}
\label{sec:org9ed59c8}
\section{Discussion}
\label{sec:org38807dc}
\section{Conclusion}
\label{sec:org810dfef}

\section{Plan}
\label{sec:orgfc9082f}
\begin{center}
\begin{tabular}{lrlrr}
...
\label{sec:orge6c2cc5}

\section{References}
\label{sec:orgaa234e1}
