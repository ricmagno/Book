...
\caption{\label{fig:org84f6810}A typical feedback loop control}
\end{figure}
...
\caption{\label{fig:org8426fe8}Construction project-driven production system}
\end{figure}
...
\caption{\label{fig:orgc5aa6ff}Transient analysis for unit step input \label{fig:Transient}}
\end{figure}
...
\label{sec:orgedd4fde}
\subsubsection{Production plan, monitoring, and control}
\label{sec:orgecc70e3}
\begin{enumerate}
\item Throughput
\label{sec:orgcab8f2e}
...
\label{sec:org688ee62}
\item Worst cycle-time
\label{sec:orgdd1be7b}
\item Best cycle-time
\label{sec:org346cce1}
\end{enumerate}
\item Capacity
\label{sec:org0880565}
