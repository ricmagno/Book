...
\label{sec:org1369163}
\subsection{Abstract}
\label{sec:org03b7b20}
...
\label{sec:org48ebbb3}
\begin{enumerate}
\item Introduction
\label{sec:org44d62c4}
...
\caption{\label{fig:orgef437d6}Construction project-driven production system}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[height=150]{./Figures/A_typical_feedback_loop_control.eps}
\caption{\label{fig:org367fa5d}A typical feedback loop control}
\end{figure}
...
\label{sec:org3d5bf03}
\begin{enumerate}
\item Throughput
\label{sec:orga29b560}
...
\label{sec:orgf3e3aba}

\item Worst cycle-time
\label{sec:org869038f}
\item Best cycle-time
\label{sec:org1e1dc8a}
\end{enumerate}
\end{enumerate}
\item Production plan, monitoring, and control
\label{sec:org21fb4f3}
\end{enumerate}
\item Applicability
\label{sec:orgfd6eba3}
\begin{enumerate}
\item Automation and technology
\label{sec:org6298d3e}
\begin{enumerate}
\item Supervisory control and data acquisition (SCADA)
\label{sec:orgc30378c}
\item Challenges
\label{sec:org7723502}
\end{enumerate}
\item Decision-making support
\label{sec:org848e2b8}
\item Benefits and impacts
\label{sec:org534b55a}
\end{enumerate}
\item Discussion
\label{sec:org78664db}
\item Conclusion
\label{sec:org87e24b6}
Papers:
