...
\caption{\label{fig:org9f9e96c}A typical feedback loop control}
\end{figure}
...
\caption{\label{fig:org28c1037}Construction project-driven production system}
\end{figure}
...
\caption{\label{fig:org79e993a}Transient analysis for unit step input \label{fig:Transient}}
\end{figure}
...
\label{sec:org79b16a9}
\subsubsection{Production plan, monitoring, and control}
\label{sec:org6b83a0d}
\begin{enumerate}
\item Throughput
\label{sec:org2186c37}
...
\label{sec:orgd125afc}
\item Worst cycle-time
\label{sec:org16a9c1a}
\item Best cycle-time
\label{sec:org78da532}
\end{enumerate}
\item Capacity
\label{sec:org955ee10}
