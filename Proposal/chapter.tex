...
\label{sec:org3e88cc6}
\subsection{Abstract}
\label{sec:org1a8d917}
...
\label{sec:org097d229}
\subsubsection{Introduction}
\label{sec:org06149e3}
...
\caption{\label{fig:org1fb879a}Construction project-driven production system}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[height=150]{./Figures/A_typical_feedback_loop_control.eps}
\caption{\label{fig:org85c16ca}A typical feedback loop control}
\end{figure}
...
\label{sec:org188ab22}
\begin{enumerate}
\item Throughput
\label{sec:org307c877}
...
\label{sec:org78e2172}

\item Worst cycle-time
\label{sec:org07eae9e}
\item Best cycle-time
\label{sec:orgaf2abcc}
\end{enumerate}
\end{enumerate}
\item Production plan, monitoring, and control
\label{sec:org2c17bbe}
\end{enumerate}
\item Applicability
\label{sec:org36362fd}
\begin{enumerate}
\item Automation and technology
\label{sec:orge07b9fa}
\begin{enumerate}
\item Supervisory control and data acquisition (SCADA)
\label{sec:org1f9e072}
\item Challenges
\label{sec:orgd7f5434}
\end{enumerate}
\item Decision-making support
\label{sec:org0ffedc5}
\item Benefits and impacts
\label{sec:org54ebf36}
\end{enumerate}
\item Discussion
\label{sec:orgcf12398}
\item Conclusion
\label{sec:orga21f45b}
Papers:
